...
function bspk_theme_styles(){
	...
	wp_enqueue_style ( 'main_css', get_template_directory_uri(). '/style.css?v=1.0.12' );
...
function bspk_theme_js() {
	...
	wp_enqueue_script( 'main', get_template_directory_uri() . '/assets/js/main.js?v=1.0.12', array('jquery'), '', true);
}
